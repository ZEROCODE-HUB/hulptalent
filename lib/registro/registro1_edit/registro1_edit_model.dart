...
import '/index.dart';
import 'registro1_edit_widget.dart' show Registro1EditWidget;
...
class Registro1EditModel extends FlutterFlowModel<Registro1EditWidget> {
  ...
  bool isDataUploading_perfil = false;
  FFUploadedFile uploadedLocalFile_perfil =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_perfil = '';
