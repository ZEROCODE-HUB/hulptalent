        ...
        appBar: AppBar(
          ...
          title: Text(
            valueOrDefault<String>(
              widget!.servicio?.clienteNombres,
              '-',
            ),
                                              ...
                                              itemBuilder: (context,
                                                ...
                                                return Container(
                                                  child: MensajesWidget(
                                                    key: Key(
                                                        'Keyo6q_${conversacionesIndex}_of_${conversaciones.length}'),
                                                    rolRemitente:
                                                        conversacionesItem
                                                            .rolRemitente,
                                                    tipoMensaje:
                                                    ...
                                                    urlArchivo:
                                                        conversacionesItem
                                                            .archivoUrl,
                                                    mensaje: conversacionesItem
                                                        .contenido,
                                                    reciboID: conversacionesItem
                                                        .reciboId,
                                                    urlImagen:
                                                        valueOrDefault<String>(
                                                      conversacionesItem
