...
import 'miperfil_model.dart';
export 'miperfil_model.dart';
                              ...
                              Flexible(
                                child: Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      '${valueOrDefault<String>(
                                        columnUsuariosRow?.nombres,
                                        'Pedro',
                                      )} ${valueOrDefault<String>(
                                        columnUsuariosRow?.apellidos,
                                        ' Fernandez',
                                      )}',
                                      'Pedro Fernandez',
                                    ),
                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      DatospersonalesWidget.routeName,
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      TerminosycondicionesWidget.routeName,
                                      extra: <String, dynamic>{
                                        '__transition_info__': TransitionInfo(
                                          hasTransition: true,
                                          transitionType:
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      PoliticasDePrivacidadWidget.routeName,
                                      extra: <String, dynamic>{
                                        '__transition_info__': TransitionInfo(
                                          hasTransition: true,
                                          transitionType:
