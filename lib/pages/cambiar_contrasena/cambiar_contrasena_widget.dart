...
class _CambiarContrasenaWidgetState extends State<CambiarContrasenaWidget> {
  ...
  String? _validateCurrentPassword(String? value) {
    if (value == null || value.isEmpty) return 'Ingresa tu contrasena actual';
    return null;
  }

  String? _validateNewPassword(String? value) {
    if (value == null || value.isEmpty) return 'Ingresa la nueva contrasena';
  ...
  String? _validateConfirmPassword(String? value) {
    if (value == null || value.isEmpty) return 'Confirma la nueva contrasena';
  ...
  Future<void> _onSubmit() async {
    ...
    try {
      ...
      if (response.user == null) {
        _showError('La contrasena actual es incorrecta');
        return;
      }
      ...
      // Step 3: Success
      if (mounted) {
        _showSuccess('Contrasena actualizada exitosamente');
      ...
      _showError('Ocurrio un error inesperado');
    } finally {
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Por seguridad, ingresa tu contrasena actual antes de establecer una nueva.',
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Requisitos de la contrasena:', style: style.override(
              font: GoogleFonts.inter(fontWeight: FontWeight.w600),
              fontWeight: FontWeight.w600,
            )),
            const SizedBox(height: 6.0),
            Text('  \u2022  Minimo 8 caracteres', style: style),
            Text('  \u2022  Al menos una letra mayuscula', style: style),
            Text('  \u2022  Al menos un numero', style: style),
          ],
        ),
      ),
    );
